    ...
    <div class="container-fluid h-100">
      <div class="row h-100">
        <div class="col nav flex-column nav-pills" style="max-width:200px" id="v-pills-tab" role="tablist"
          ...
          <a class="nav-link active" id="v-pills-public-tab" data-toggle="pill" href="#v-pills-public" role="tab"
             @click="$router.push({path:'/policy/public'})"
             aria-controls="v-pills-public" aria-selected="true">国家政策</a>
          <a class="nav-link" id="v-pills-school-tab" data-toggle="pill" href="#v-pills-school" role="tab"
             @click="$router.push({path:'/policy/school'})"
             aria-controls="v-pills-school" aria-selected="false">学校文件</a>
          <a class="nav-link" id="v-pills-company-tab" data-toggle="pill" href="#v-pills-company" role="tab"
             @click="$router.push({path:'/policy/company'})"
             aria-controls="v-pills-company" aria-selected="false">公司制度</a>
        </div>
        <div class="col tab-content" id="v-pills-tabContent">
          <div class="tab-pane fade h-100 show active h-100" id="v-pills-public" role="tabpanel"
               aria-labelledby="v-pills-public-tab">
            <div class="contentCard d-flex flex-column h-100">
              <div class="title row w-100 align-self-center mt-1" style="padding:0 15px;height: 50px;">
                <div class="titleL col d-flex align-items-center pl-0"
                  ...
                  <span
                      style="bottom: -2px;position: relative;line-height: 46px; border-bottom: #204BB0 solid 2px;height: 100%;">国家政策</span>
                </div>
                <div class="titleR col-auto d-flex align-items-center justify-content-center pr-0"
                  ...
                  <a href="/policy/public" class="bread breadNav">- 国家政策</a>
                </div>
              </div>
          ...
          <div class="tab-pane fade h-100" id="v-pills-school" role="tabpanel" aria-labelledby="v-pills-school-tab">
            <div class="contentCard d-flex flex-column h-100">
              <div class="title row w-100 align-self-center mt-1" style="padding:0 15px;height: 50px;">
                <div class="titleL col d-flex align-items-center pl-0"
                     style="border-bottom: rgb(215,215,215) solid 2px;font-family: 'Arial Negreta', 'Arial Normal', 'Arial';font-weight: 700;color: #204BB0;">
                  <span
                      style="bottom: -2px;position: relative;line-height: 46px; border-bottom: #204BB0 solid 2px;height: 100%;">学校文件</span>
                </div>
                <div class="titleR col-auto d-flex align-items-center justify-content-center pr-0"
                     style="border-bottom: rgb(215,215,215) solid 2px;">
                  <span class="bread">当前位置：</span>
                  <a href="/" class="bread breadNav">首页</a>
                  <a href="/policy" class="bread breadNav">- 政策法规</a>
                  <a href="/policy/school" class="bread breadNav">- 学校文件</a>
                </div>
              </div>
              <div class="contentBox d-flex flex-column" style="flex: 1;padding:16px 15px">
                <ul class="d-flex flex-column flex-grow-1">
          ...
          <div class="tab-pane fade h-100" id="v-pills-company" role="tabpanel" aria-labelledby="v-pills-company-tab">
            <div class="contentCard d-flex flex-column h-100">
              <div class="title row w-100 align-self-center mt-1" style="padding:0 15px;height: 50px;">
                <div class="titleL col d-flex align-items-center pl-0"
                     style="border-bottom: rgb(215,215,215) solid 2px;font-family: 'Arial Negreta', 'Arial Normal', 'Arial';font-weight: 700;color: #204BB0;">
                ...
                <div class="titleR col-auto d-flex align-items-center justify-content-center pr-0"
                  ...
                  <a href="/" class="bread breadNav">首页</a>
                  <a href="/policy" class="bread breadNav">- 政策法规</a>
                  <a href="/policy/company" class="bread breadNav">- 公司制度</a>
                </div>
              </div>
              <div class="contentBox d-flex flex-column" style="flex: 1;padding:16px 15px">
                <ul class="d-flex flex-column flex-grow-1">
  ...
  export default {
    ...
    watch: {
      '$route.params.content'(v) {
        if (v) {
          $('#policy #v-pills-' + v.replace("#", "") + '-tab').tab('show')
        }
      }
    },
    mounted() {
      if (this.$route.params.content) {
        $('#policy #v-pills-' + this.$route.params.content.replace("#", "") + '-tab').tab('show')
      }
      if (this.$route.hash) {

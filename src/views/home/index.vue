    ...
    <div class="container-fluid">
            ...
            <div class="msgLinkCard d-flex flex-column h-100">
              ...
              <div class="msgLinkBox pt-3" style="flex: 1">
                <ul
                  ...
                  :style="
                    'max-height: calc(100% * (' + articleList0.length + '/8))'
                  "
                >
                  <li
      ...
      <div class="row mt-3 mt-lg-5">
        <div class="col col-lg-8 col-12 pl-lg-0">
          <div
            class=""
            style="width: 100%;height: 420px;border: 1px solid rgb(215,215,215);"
          >
            <div class="msgLinkCard d-flex flex-column h-100">
              <div
                class="title row w-100 align-self-center mt-1"
              ...
              <div class="msgLinkBox pt-3" style="flex: 1">
                <div class="listBox h-100 pl-3" style="overflow-y: hidden">
                  ...
                  >
                    ...
                    >
                      <div
                        style="height: 100%;box-sizing: content-box;max-height: 300px;"
                      >
                        <div
                          class="w-100"
                          style="background-color: #8dcce8;height: 55%;"
                        >
                          <img
                            :src="item3.cover"
                            alt=""

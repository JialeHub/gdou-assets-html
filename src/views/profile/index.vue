    ...
    <div class="container-fluid h-100">
      <div class="row h-100">
        ...
        >
          ...
          <a
            class="nav-link"
            id="v-pills-framework-tab"
            data-toggle="pill"
            href="#v-pills-framework"
            role="tab"
            @click="$router.push({ path: '#framework' })"
            aria-controls="v-pills-pills"
            aria-selected="false"
            >组织架构</a
          >
          <a
              ...
              <div class="contentBox" style="flex: 1 1 auto;margin:16px 15px">
                <ul class="row">
                  <li
                    ...
                    v-if="item.sequence >= 100"
                    :key="item.id"
                    style="max-width:93%;margin-left: 3%;padding: 20px 20px;background-color: rgb(255,255,255);border-radius: 10px;margin-top: 10px;margin-bottom: 30px;"
                  >
                    <h3
                      class="name"
                      style="color: #204BB0;font-weight: bold;font-size: 24px;letter-spacing:2px;"
                    >
                      {{ item.name }}
                    </h3>
                    <p
                  ...
                  <li
                    class="col-6"
                    v-for="item2 in teamMember"
                    v-if="item2.sequence < 100"
                    :key="item2.id"
                    style="max-width:45%;margin-left: 3%;padding: 20px 20px;background-color: rgb(255,255,255);border-radius: 10px;margin-top: 10px;margin-bottom: 30px;"
                  >
                    <h3
                      class="name"
                      style="color: #204BB0;font-weight: bold;font-size: 24px;letter-spacing:1px;"
                    >
                      {{ item2.name }}
                    </h3>
                    <p
              ...
              >
                ...
                >
                  ...
                  <a
                    ...
                    >- 公司概况</a
                  >
                  <a href="/profile#framework" class="bread breadNav"
                    >- 组织架构</a
                  >
                </div>
              </div>
            ...
            <div class="contentCard d-flex flex-column h-100">
              ...
              >
                ...
                >
                  ...
                  <a href="/" class="bread breadNav">首页</a>
                  <a href="/profile" class="bread breadNav">- 公司概况</a>
                  <a href="/profile#contact" class="bread breadNav"
                    >- 联系我们</a
                  >
                </div>
              </div>
              <div class="contentBox" style="flex: 1 1 auto;margin:16px 15px">
                ...
                >
                  广东海洋大学湛江资产经营有限公司联系方式
                </h3>
                <div style="padding-left: 20px;padding-top: 50px;">
                  <p style="font-size: 16px">电话：{{ this.contact.phone }}</p>
                  <p style="font-size: 16px">
                    邮箱：{{ this.contact.postbox }}
                  </p>
                  <p style="font-size: 16px">
                    地址：{{ this.contact.address }}
                  </p>
                  <p style="font-size: 16px">
                    邮编：{{ this.contact.postcode }}
                  </p>
                  <p style="font-size: 16px">
                    公众微信号：{{ this.contact.publicAccounts }}
                  </p>
                  <p style="font-size: 16px">
                    微信号：{{ this.contact.weChat }}
                  </p>
                </div>
              </div>
            </div>

...
// 获取合作类型列表
export const typeListCooperationApi = data =>
  axiosG("cooperation/typeList", data);
// 合作成果模糊查询
export const dimFindCooperationApi = data =>
  axiosG("cooperation/dimFind", data);
...
// 获取主公司组织架构图
export const companyFrameworkImgGetApi = data =>
  axiosG("company/frameworkImg", data);
// 获取主公司简介
